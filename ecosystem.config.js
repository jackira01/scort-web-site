// Configuración PM2 para producción - Prepago Ya
module.exports = {
  apps: [
    {
      // Configuración del Backend
      name: 'prepago-ya-backend',
  ...
  deploy: {
    production: {
      ...
      host: ['your-server-ip'],
      ref: 'origin/main',
      repo: 'git@github.com:yourusername/prepago-ya.git',
      path: '/var/www/prepago-ya',
      'pre-deploy-local': '',
    ...
    staging: {
      ...
      ref: 'origin/develop',
      repo: 'git@github.com:yourusername/prepago-ya.git',
      path: '/var/www/prepago-ya-staging',
      'pre-deploy-local': '',
