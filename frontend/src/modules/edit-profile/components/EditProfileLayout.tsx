...
export function EditProfileLayout({ profileId }: EditProfileLayoutProps) {
  ...
  useEffect(() => {
    if (profileDetails && attributeGroups) {
      ...
      const formData = {
        ...
        socialMedia: {
          instagram: profileDetails.socialMedia?.instagram || (verificationData as any)?.data?.steps?.socialMedia?.instagram || '',
          facebook: profileDetails.socialMedia?.facebook || (verificationData as any)?.data?.steps?.socialMedia?.facebook || '',
          tiktok: profileDetails.socialMedia?.tiktok || (verificationData as any)?.data?.steps?.socialMedia?.tiktok || '',
          twitter: profileDetails.socialMedia?.twitter || (verificationData as any)?.data?.steps?.socialMedia?.twitter || '',
          onlyFans: profileDetails.socialMedia?.onlyFans || (verificationData as any)?.data?.steps?.socialMedia?.onlyFans || '',
        },
        selectedUpgrades: [],
  ...
  }, [profileDetails, attributeGroups, assignedPlan, verificationData]);
