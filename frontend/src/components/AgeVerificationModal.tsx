...
const AgeVerificationModal: React.FC<AgeVerificationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      <div className="max-h-[90vh] w-full max-w-md overflow-y-auto scrollbar-thin scrollbar-thumb-muted-foreground/30 scrollbar-track-transparent rounded-xl">
        <Card className="w-full mx-auto shadow-2xl border-2">
