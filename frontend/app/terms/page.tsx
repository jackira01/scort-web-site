...
import { ArrowLeft, FileText, Scale, Shield, AlertTriangle, Clock, Mail } from "lucide-react"
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold text-foreground">Términos y Condiciones</span>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12 animate-in fade-in-50 slide-in-from-bottom-4 duration-500">
          ...
          <p className="text-lg text-muted-foreground mb-6 max-w-3xl mx-auto">
            Lea cuidadosamente nuestros términos y condiciones antes de utilizar nuestros servicios.
          </p>
            ...
            <div className="sticky top-24 space-y-2 animate-in slide-in-from-left-4 duration-500">
              ...
              <Card className="mt-8 bg-card border-border">
                <CardContent className="p-4 text-center">
                  ...
                  <h4 className="font-semibold text-foreground mb-2">¿Preguntas legales?</h4>
                  ...
                  <CardContent className="space-y-8">
                    {section.content.map((item, index) => (
                      ...
                      >
                        ...
                        <p className="text-muted-foreground leading-relaxed pl-4">{item.text}</p>
                      </div>
                    ))}
                  </CardContent>
                </Card>
            ...
            <Card className="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-blue-200 dark:border-blue-800">
              <CardContent className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Aviso Importante</h4>
                    <p className="text-blue-700 dark:text-blue-300 text-sm leading-relaxed">
                      Estos términos y condiciones constituyen un acuerdo legal entre usted y nuestra empresa. Al
                      utilizar nuestros servicios, usted acepta cumplir con todos los términos aquí establecidos. Si
                      tiene alguna pregunta sobre estos términos, por favor contáctenos antes de utilizar nuestros
                      servicios.
                    </p>
                  </div>
                </div>
