...
import { Calendar, MapPin, Eye, Star, Edit, CheckCircle, Plus } from "lucide-react"
...
export default function ProfileList({ profiles, getProgressColor, getProgressTextColor }: ProfileListProps) {
  return (
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className={`font-medium ${getProgressTextColor(profile.completeness)}`}>
