...
exports.runBusinessRuleTests = exports.testCases = exports.applyCouponToPlan = void 0;
...
exports.applyCouponToPlan = applyCouponToPlan;
exports.testCases = [
    {
...
const runBusinessRuleTests = () => {
    console.log('🧪 Ejecutando pruebas de reglas de negocio para cupones...\n');
    let allTestsPassed = true;
    exports.testCases.forEach((testCase, index) => {
        const result = (0, exports.applyCouponToPlan)(testCase.plan, testCase.coupon);
        const passed = result.finalPrice === testCase.expected.finalPrice &&
...
exports.runBusinessRuleTests = runBusinessRuleTests;
