/**
 * 🧩 REGLAS DE NEGOCIO PARA CUPONES Y DESCUENTOS
 * 
 * Este archivo contiene las reglas de negocio claras para la aplicación de cupones:
 * 1. No se pueden aplicar cupones o descuentos a planes gratuitos
 * 2. No se permiten descuentos que dejen el precio final en negativo
 * 3. Los descuentos válidos pueden ser: Porcentaje (%) o Valor fijo ($)
 */
...
/**
 * 💡 Lógica principal para aplicar cupones a planes
 * 
 * @param plan - Plan al que se aplicará el cupón
 * @param coupon - Cupón a aplicar (opcional)
 * @returns Precio final después de aplicar el cupón
 */
export const applyCouponToPlan = (plan: Plan, coupon?: Coupon): CouponApplicationResult => {
...
/**
 * 📊 Casos de prueba según especificaciones
 */
export const testCases = [
  {
    description: "Plan gratuito con cupón 50%",
    plan: { price: 0 },
    coupon: { type: "PERCENTAGE" as const, value: 50 },
    expected: { finalPrice: 0, success: false, error: "El cupón no puede aplicarse a planes gratuitos" }
  },
  {
  ...
  },
  {
    ...
    plan: { price: 100000 },
    coupon: { type: "FIXED" as const, value: 120000 },
    expected: { finalPrice: 0, success: true } // No negativo
  },
  {
    description: "Plan $200.000 con cupón fijo $50.000",
    plan: { price: 200000 },
    coupon: { type: "FIXED" as const, value: 50000 },
    expected: { finalPrice: 150000, success: true }
  }
];

/**
 * 🧪 Función para ejecutar pruebas de las reglas de negocio
 */
export const runBusinessRuleTests = (): boolean => {
